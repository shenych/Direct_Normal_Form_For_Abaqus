...
path='C:/YichangShen/ROM_challenge/DNF_ABAQUS_Code/Program_v1/';
%current path of the main code and the folder of functions.

meshfile='C:/YichangShen/ROM_challenge/DNF_ABAQUS_Code/Program_v1/Examples/Beam_cantilever.inp'; 
...
dof_of_rotation=3; % and how many dofs for the rotations?  (DRX DRY DRZ)
...
[AH,BH,G,H,a_ten,b_ten,r_ten,Omega,PHI,qa,qb,q]=DNF_in_FE(master_modes,dof_of_disp,dof_of_rotation,disp_applied,path,meshfile);
